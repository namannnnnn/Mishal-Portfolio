  ...
  $(document).ready(function () {
    ...
    if (
      ...
      var h = $(".app-design"),
        ...
        f = new ScrollMagic.Scene({ triggerElement: h, reverse: !1 })
          .setTween(
            TweenLite.from(u, 0.8, { x: 100, opacity: 0, ease: Power1.easeOut })
          )
          .addTo(e),
        c = $(".web-design"),
        p = $(".web-design__visual"),
        d = new ScrollMagic.Scene({ triggerElement: c, reverse: !1 })
          .setTween(
            TweenLite.from(p, 0.8, {
              x: -100,
              opacity: 0,
              ease: Power1.easeOut,
            })
